...
void EC_ClassiqueP::UpdateSecondMembre(int num_it)
{
  ...
  if ((_CL_haut == "Dirichlet") and (_Me == 0)) //Condition de température en haut
  {
    for (int j = 0; j < _Nx; j++)
    {
  ...
  if ((_CL_bas == "Dirichlet") and (_Me == _Np - 1)) //Condition de température en bas
  {
    for (int j = 0; j < _Nx; j++)
    {
  ...
  if ((_CL_haut == "Neumann") and (_Me == 0)) //Condition de flux en haut
  {
    for (int j = 0; j < _Nx; j++)
    {
  ...
  if ((_CL_bas == "Neumann") and (_Me == _Np - 1)) //Condition de flux en bas
  {
    for (int j = 0; j < _Nx; j++)
    {
